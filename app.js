  ...
  try {
    ...
    try {
      if (cfg && hist) {
        ...
        finalRows = computeRealRows(rows, hist, cfg, ov, peakMap, dailyVolByUrl, medianHsByUrl);
      }
    } catch (e) {
...
function computeRealRows(rawRows, hist, cfg, overridesMap, peakByUrl, dailyVolByUrl, medianHsByUrl) {
