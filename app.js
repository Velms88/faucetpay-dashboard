...
const BLOCK1_KEYS = ['daily_volume_usd', 'rvi', 'health_score', 'payout_activity_hours', 'rai'];
...
function renderRealFormulas(container) {
  ...
  const tables = [
    ...
    { key: 'rvi', title: 'Блок 1 · Индекс волатильности выплат (rvi)', mode: 'min', fallback: true, block: 1 },
    ...
    { key: 'rai', title: 'Блок 1 · Индекс активности претензий (rai)', mode: 'min', fallback: true, block: 1 },
