...
async function saveConfigToTurso(mode, config) {
  ...
  const safe = Object.assign({}, defaultFormulaConfig(), config || {});
  safe.settings = Object.assign(
    { history_retention_days: 7, history_file: 'history.json', data_file: 'faucets.json', group_by: 'category' },
