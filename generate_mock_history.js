...
// Built-in demo faucet list. Used by the sandbox dry-run when the stored
// config has no `targets` (the "all faucets are targets" model no longer
// relies on a curated target list). Acts as the sandbox's demo "all faucets".
const DEMO_FAUCETS = [
  { url: 'https://cointiply.com', label: 'stable', age_months: 36, payout_type: 'internal', gateways_count: 3, uii: 85, is_enabled: true },
  { url: 'https://freebitco.in', label: 'stable', age_months: 84, payout_type: 'internal', gateways_count: 2, uii: 90, is_enabled: true },
  { url: 'https://firefaucet.win', label: 'fluctuating', age_months: 30, pay_type: 'internal', gateways_count: 5, uii: 70, is_enabled: true },
  { url: 'https://faucetcrypto.net', label: 'stable', age_months: 18, payout_type: 'internal', gateways_count: 2, uii: 60, is_enabled: true },
  { url: 'https://claimfreecoins.io', label: 'declining', age_months: 24, payout_type: 'internal', gateways_count: 1, uii: 50, is_enabled: true },
  { url: 'https://cryptotabbrowser.com', label: 'fluctuating', age_months: 40, payout_type: 'internal', gateways_count: 1, uii: 55, is_enabled: true },
  { url: 'https://adbtc.top', label: 'stable', age_months: 60, payout_type: 'internal', gateways_count: 1, uii: 65, is_enabled: true },
  { url: 'https://btcclicks.com', label: 'declining', age_months: 96, payout_type: 'internal', gateways_count: 1, uii: 45, is_enabled: false },
  { url: 'https://starbits.io', label: 'dried', age_months: 12, payout_type: 'internal', gateways_count: 1, uii: 30, is_enabled: true },
  { url: 'https://bonusbitcoin.co', label: 'stable', age_months: 48, payout_type: 'internal', gateways_count: 1, uii: 58, is_enabled: false },
  { url: 'https://moonbitcoin.cash', label: 'declining', age_months: 36, payout_type: 'internal', gateways_count: 1, uii: 40, is_enabled: true },
  { url: 'https://dailyfreebits.com', label: 'dried', age_months: 20, payout_type: 'internal', gateways_count: 1, uii: 25, is_enabled: true },
];
...
function generate(config) {
  ...
  const targets = (config.targets && config.targets.length) ? config.targets : DEMO_FAUCETS;
  const faucets = targets.map((target, index) => {
...
module.exports = { generate, CRYPTO_PRICES_USD, DEMO_FAUCETS };
