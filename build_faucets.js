...
function enrichFaucets(raw, history, config, overridesMap, dailyVolByUrl, medianHsByUrl) {
...
async function main() {
  ...
  // Блок 1 daily_volume + health: эталоны из raw_hourly (если доступны креды Turso).
  ...
  const enrichResult = enrichFaucets(raw, history, config, overridesMap, dailyVolByUrl, medianHsByUrl);
