...
async function fetchCryptoPrices(symbols, opts) {
  ...
  // Priority: CoinCap < CoinGecko < Binance. Binance USDT pairs are the most
  // reliable for majors; CoinGecko fills the gaps (e.g. FEY) the others miss.
  const merged = Object.assign({}, coincapMap, coingeckoMap, binanceMap);
